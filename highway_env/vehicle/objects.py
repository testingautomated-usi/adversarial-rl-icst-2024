...
class RoadObject(ABC):
    ...
    def handle_collisions(self, other: 'RoadObject', dt: float = 0) -> None:
        ...
        """
        #print('calling handle collisions')
        ...
        #print('will intersect: ', will_intersect)
        ...
        if will_intersect:
            ...
            #fix the empty crashed list bug
            self.vehicle_in_crash  = (type(self).__name__, type(other).__name__)
            #print('crashed list 2: ', (type(self).__name__, type(other).__name__))
        if intersecting:
            #print('opt 4')
            if self.solid and other.solid:
                self.crashed = True
            ...
            self.vehicle_in_crash = (type(self).__name__, type(other).__name__)
            #print('crashed list: ', self.crashed_list)
            #print('obj self. crashed: ', self.crashed)
            #print('obj other. crashed: ', other.crashed)
