...
class RecordVideo(gym.Wrapper):
    ...
    def __init__(
        ...
        disable_logger: bool = False, ttc_thr = 0.5
    ):
        ...
        self.ttc_reward = None
        self.ttc_thr = ttc_thr
    ...
    def _video_enabled(self):
        ...
        if (self.ttc_reward is not None) and (self.ttc_reward > self.ttc_thr):
            return True
        else:
            return False
    ...
    def step(self, action):
        ...
        self.ttc_reward = infos['time_to_collision_reward']
